...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { client_id: @measurement.client_id, style: @measurement.style } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { client_id: @measurement.client_id, style: @measurement.style } }
