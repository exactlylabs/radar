...
curl -s -f "${URL}" -o "${TARGET_DIR}/tl_us_aiannh.zip"
...
do
    ...
    curl -sf "${URL}tl_${YEAR}_${state_fips}_tract.zip" -o "${TARGET_DIR}/tracts/tl_${state_fips}_tract.zip" || true
done
