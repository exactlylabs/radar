...
function GoToLink({href, text}: {href: string, text: string}) {
  return (
    <a href={href} target="_blank" className={buttonStyles.readMore} data-transparent='true'>{text}
    ...
    <div className={styles.responsiveBoxesContainer}>
      <GenericExpansibleRow
        ...
        content={(
          <div className={styles.linksGrid}>
            ...
            <div className={styles.linkBox}>
              <GoToLink href="https://docs.fcc.gov/public/attachments/DOC-401205A1.pdf"
            ...
            <div className={styles.linkBox}>
              <GoToLink href="https://www.fcc.gov/consumers/guides/broadband-speed-guide"
            ...
            <div className={styles.linkBox}>
              <GoToLink href="https://www.fcc.gov/general/rural-health-care-program"
      ...
      <GenericExpansibleRow
        ...
        content={(
          <div className={styles.linksGrid}>
            <div className={styles.linkBox}>
              <GoToLink href="https://extension.psu.edu/penn-state-national-broadband-navigator"
            ...
            <div className={styles.linkBox}>
              <GoToLink href="https://info.americantelemed.org/disparities-advisory-group-toolkit"
