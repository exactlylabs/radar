...
func (_m *ASNOrgStorage) All(limit *int, offset *int) (storages.Iterator[*storages.ASNOrg], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*int, *int) (storages.Iterator[*storages.ASNOrg], error)); ok {
...
func (_m *ASNOrgStorage) AllFromGeospace(geospaceId string, limit *int, offset *int) (storages.Iterator[*storages.ASNOrg], error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for AllFromGeospace")
	}

	var r0 storages.Iterator[*storages.ASNOrg]
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *int, *int) (storages.Iterator[*storages.ASNOrg], error)); ok {
		return rf(geospaceId, limit, offset)
	}
...
func (_m *ASNOrgStorage) Get(id string) (*storages.ASNOrg, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*storages.ASNOrg, error)); ok {
		return rf(id)
	}
...
func (_m *ASNOrgStorage) GetByOrgName(name string) (*storages.ASNOrg, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetByOrgName")
	}
...
func (_m *ASNOrgStorage) SearchFromGeospace(query string, geospaceId string, limit *int, offset *int) (storages.Iterator[*storages.ASNOrg], error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for SearchFromGeospace")
	}

	var r0 storages.Iterator[*storages.ASNOrg]
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *int, *int) (storages.Iterator[*storages.ASNOrg], error)); ok {
		return rf(query, geospaceId, limit, offset)
	}
...
func NewASNOrgStorage(t interface {
	mock.TestingT
	Cleanup(func())
}) *ASNOrgStorage {
	mock := &ASNOrgStorage{}
