...
func (_m *VectorTile) GetFeatures(layer namespaces.Namespace) ([]geo.Feature, error) {
	...
	var r0 []geo.Feature
	var r1 error
	if rf, ok := ret.Get(0).(func(namespaces.Namespace) ([]geo.Feature, error)); ok {
		return rf(layer)
	}
...
// Layers provides a mock function with no fields
...
func (_m *VectorTile) Marshal(gziped bool, layers ...namespaces.Namespace) ([]byte, error) {
	...
	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(bool, ...namespaces.Namespace) ([]byte, error)); ok {
		return rf(gziped, layers...)
	}
...
func NewVectorTile(t interface {
	mock.TestingT
	Cleanup(func())
}) *VectorTile {
	mock := &VectorTile{}
