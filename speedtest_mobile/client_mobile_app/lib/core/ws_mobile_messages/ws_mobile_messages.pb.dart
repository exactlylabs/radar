...
class ScannedAP extends $pb.GeneratedMessage {
  factory ScannedAP({
    ...
    $core.Iterable<$core.List<$core.int>>? informationElements,
    ...
    if (informationElements != null) {
      $result.informationElements.addAll(informationElements);
    }
  ...
  ScannedAP._() : super();
  factory ScannedAP.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScannedAP.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScannedAP',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ws_mobile_messages_pb'),
    ...
    ..p<$core.List<$core.int>>(11, _omitFieldNames ? '' : 'informationElements', $pb.PbFieldType.PY)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ScannedAP copyWith(void Function(ScannedAP) updates) =>
      super.copyWith((message) => updates(message as ScannedAP)) as ScannedAP;
  ...
  @$core.pragma('dart2js:noInline')
  static ScannedAP getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScannedAP>(create);
  static ScannedAP? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get bssid => $_getSZ(0);
  @$pb.TagNumber(1)
  set bssid($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(3)
  set capabilities($core.String v) {
    $_setString(2, v);
  }
  ...
  @$pb.TagNumber(8)
  set is80211mcResponder($core.bool v) {
    $_setBool(7, v);
  }
  ...
  @$pb.TagNumber(10)
  set isPasspointNetwork($core.bool v) {
    $_setBool(9, v);
  }
  ...
  @$pb.TagNumber(11)
  $core.List<$core.List<$core.int>> get informationElements => $_getList(10);

  @$pb.TagNumber(12)
  $core.int get wifiStandard => $_getIZ(11);
  @$pb.TagNumber(12)
  set wifiStandard($core.int v) {
...
class ScanResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanResult',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ws_mobile_messages_pb'),
      createEmptyInstance: create)
    ..pc<ScannedAP>(1, _omitFieldNames ? '' : 'scannedAps', $pb.PbFieldType.PM,
        subBuilder: ScannedAP.create)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'latitude', $pb.PbFieldType.OF)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'longitude', $pb.PbFieldType.OF)
    ..aOM<$1.Struct>(99, _omitFieldNames ? '' : 'metadata', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false;
  ...
  static ScanResult getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScanResult>(create);
...
enum WSMessage_Message { scanResult, timestamp, json, notSet }
...
class WSMessage extends $pb.GeneratedMessage {
  ...
  WSMessage._() : super();
  factory WSMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WSMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WSMessage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ws_mobile_messages_pb'),
      createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..e<Events>(1, _omitFieldNames ? '' : 'event', $pb.PbFieldType.OE,
        defaultOrMaker: Events.SCAN_RESULT, valueOf: Events.valueOf, enumValues: Events.values)
    ...
    ..aOM<$1.Struct>(4, _omitFieldNames ? '' : 'json', subBuilder: $1.Struct.create)
