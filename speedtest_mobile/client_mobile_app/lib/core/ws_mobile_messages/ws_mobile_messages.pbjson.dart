...
final $typed_data.Uint8List eventsDescriptor = $convert
    .base64Decode('CgZFdmVudHMSDwoLU0NBTl9SRVNVTFQQABILCgdXRUxDT01FEAMSCAoEUElORxAEEgkKBU90aG'
        'VyEGM=');
...
const ScannedAP$json = {
  ...
  '2': [
    ...
    {'1': 'information_elements', '3': 11, '4': 3, '5': 12, '10': 'informationElements'},
...
final $typed_data.Uint8List scannedAPDescriptor = $convert
    .base64Decode('CglTY2FubmVkQVASFAoFYnNzaWQYASABKAlSBWJzc2lkEhIKBHNzaWQYAiABKAlSBHNzaWQSIg'
        ...
        'c3Nwb2ludE5ldHdvcmsSMQoUaW5mb3JtYXRpb25fZWxlbWVudHMYCyADKAxSE2luZm9ybWF0aW'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.ws_mobile_messages_pb.ScannedAP',
      '10': 'scannedAps'
    },
...
final $typed_data.Uint8List scanResultDescriptor = $convert
    .base64Decode('CgpTY2FuUmVzdWx0EkEKC3NjYW5uZWRfYXBzGAEgAygLMiAud3NfbW9iaWxlX21lc3NhZ2VzX3'
        'BiLlNjYW5uZWRBUFIKc2Nhbm5lZEFwcxIaCghsYXRpdHVkZRgCIAEoAlIIbGF0aXR1ZGUSHAoJ'
        'bG9uZ2l0dWRlGAMgASgCUglsb25naXR1ZGUSMwoIbWV0YWRhdGEYYyABKAsyFy5nb29nbGUucH'
        'JvdG9idWYuU3RydWN0UghtZXRhZGF0YQ==');
...
const WSMessage$json = {
  ...
  '2': [
    ...
    {'1': 'session_id', '3': 5, '4': 1, '5': 9, '10': 'sessionId'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.ws_mobile_messages_pb.ScanResult',
      '9': 0,
      '10': 'scanResult'
    },
    {
    ...
    {'1': 'json', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '9': 0, '10': 'json'},
  ],
  '8': [
    {'1': 'message'},
  ],
...
final $typed_data.Uint8List wSMessageDescriptor = $convert
    .base64Decode('CglXU01lc3NhZ2USMwoFZXZlbnQYASABKA4yHS53c19tb2JpbGVfbWVzc2FnZXNfcGIuRXZlbn'
        'RzUgVldmVudBIdCgpzZXNzaW9uX2lkGAUgASgJUglzZXNzaW9uSWQSRAoLc2Nhbl9yZXN1bHQY'
        'AiABKAsyIS53c19tb2JpbGVfbWVzc2FnZXNfcGIuU2NhblJlc3VsdEgAUgpzY2FuUmVzdWx0Ej'
        'oKCXRpbWVzdGFtcBgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBIAFIJdGltZXN0'
        'YW1wEi0KBGpzb24YBCABKAsyFy5nb29nbGUucHJvdG9idWYuU3RydWN0SABSBGpzb25CCQoHbW'
        'Vzc2FnZQ==');
