class AddNetworkOutage < ActiveRecord::Migration[6.1]
  def change
    drop_table :client_outages
    add_column :outage_events, :cancelled_at, :datetime

    create_table :network_outages do |t|
