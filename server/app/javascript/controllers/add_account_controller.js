...
export default class extends Controller {
    ...
    handleAccountNameChange(e) {
        const disableButtonClasses = ["custom-button--disabled", "disabled"]
        if (
            e.target.value !== null &&
            ...
            if (this.hasContinueToShareButtonTarget) {
                this.continueToShareButtonTarget.classList.remove(...disableButtonClasses);
            } else {
                this.createAccountButtonTarget.classList.remove(...disableButtonClasses);
            }
        } else {
            if (this.hasContinueToShareButtonTarget) {
                this.continueToShareButtonTarget.classList.add(...disableButtonClasses);
            } else {
                this.createAccountButtonTarget.classList.add(...disableButtonClasses);
            }
        }
    ...
    createAccount() {
        ...
        fetch("/accounts", {
            ...
            .then((res) => {
                if (res.status === "ok") {
                    window.location.href = "/dashboard?new_account=true"
