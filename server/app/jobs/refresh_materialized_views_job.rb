class RefreshMaterializedViewsJob < ApplicationJob
  ...
  def perform()
    ...
    ActiveRecord::Base.connection.execute("REFRESH MATERIALIZED VIEW aggregated_pod_measurements_by_hours")
    ActiveRecord::Base.connection.execute("REFRESH MATERIALIZED VIEW aggregated_pod_measurements_by_days")
  end
end
