...
Rails.application.routes.draw do
  ...
  get 'slim_client_download_speed', to: 'dashboard#slim_client_download_speed'
  get 'slim_client_upload_speed', to: 'dashboard#slim_client_upload_speed'
  get 'slim_network_download_speed', to: 'dashboard#slim_network_download_speed'
  get 'slim_network_upload_speed', to: 'dashboard#slim_network_upload_speed'
