...
export const layerMouseoverHandler = (ev: LeafletMouseEvent, layer: any, speedType: string, selectedSpeedFilters: Array<string>, selectedGeospace: Optional<GeospaceInfo>) => {
...
export const layerMouseoutHandler = (ev: LeafletMouseEvent, layer: any, speedType: string, selectedSpeedFilters: Array<string>, selectedGeospace: Optional<GeospaceInfo>) => {
  const summary: GeospaceOverview = JSON.parse(ev.propagatedFrom.feature.properties.summary) as GeospaceOverview;
...
export const paintLayer = (map: L.Map, layer: any, selectedGeospace: Optional<GeospaceInfo>, speedType: string, selectedSpeedFilters: Array<string>) => {
...
export const mouseOverFeatureStyleHandler = (layer: any, feature: any, mouseOverGeospace: GeospaceOverview, selectedGeospace: Optional<GeospaceInfo>, speedType: string, selectedSpeedFilters: Array<string>) => {
  ...
  if(currentFeatureProperties?.summary !== undefined) {
    ...
    const key: string = getSignalState(speedType as string, currentFeatureSummary);
    const shouldColorFill: boolean = shouldShowLayer(currentFeatureSummary, speedType, selectedSpeedFilters);
    if(isCurrentFeature) {
      const tooltip: ReactElement = <GeographicalTooltip geospace={currentFeatureSummary} speedType={speedType}/>;
...
export const featureStyleHandler = (feature: any, selectedGeospace: Optional<GeospaceInfo>, speedType: Filter, selectedSpeedFilters: Array<Filter>) => {
  ...
  if (properties.summary !== undefined) {
    ...
    const key: string = getSignalState(speedType as string, summary);
