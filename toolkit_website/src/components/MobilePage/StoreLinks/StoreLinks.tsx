...
const StoreLinks = (): ReactElement => {
  ...
  return (
    <div style={styles.StoreLinks(isSmallScreen)}>
      <a href="https://apps.apple.com/id/app/radar-speed-test/id1660999617" target="_blank">
        <img src={AppStoreIcon} style={styles.StoreIcon} alt={'appstore icon'} />
      </a>
      <a href="https://play.google.com/store/apps/details?id=org.anthc.radar&hl=en_US&pli=1" target="_blank">
